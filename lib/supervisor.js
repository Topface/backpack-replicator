(function(module) {
     ...
     * May be used only once for one replicator.
     *
     * @param zk Zookeeper (zkjs) session instance, not started (will be used exclusively)
     * @param {Number} concurrency Concurrency for replicator
     * @constructor
     */
    ...
    /**
     * Return replicator in callback and start watching for configuration changes.
     *
     * @param {Function} callback Callback to receive repliacator
     */
     ...
     *
     * @param {Function} callback Initial callback to create replicator
     */
    ...
    /**
     * Close supervisor and stop monitoring configuration updates.
     * Will not stop replicator, you should do it manually.
     */
